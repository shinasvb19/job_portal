...
const PostElement = () => {
  ...
  return (
    <div className="bg-[#FFFFFF] hidden md:flex flex-col  h-[100px] mb-10 w-[450px] mx-auto shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]   px-4  rounded-lg  md:sticky  md:top-32">
